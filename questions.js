...
//       "The reparameterization trick can be written as z = μ + σ ⊙ ε, ε ~ N(0, I).",
...
//       "Gain(S, a) = E(S) - Σ_{v ∈ Values(a)} (|S_v| / |S|) * E(S_v).",
...
//   },
//   {
//     "question": "Which statements about W_i^h = (w_{i,1}^h, w_{i,2}^h, ..., w_{i,H_{n-1}}^h) are correct in a deeper architecture?",
//     "answers": [
...
//   },
//   {
//     "question": "For the basic RNN equations h_t = ϕ(W_xh * x_t + W_hh * h_{t-1} + b_h) and y_t = W_hy * h_t + b_y, which statements are correct?",
//     "answers": [
...
//   },
//   {
//     "question": "Consider a dataset that is difficult to separate by a straight line in Cartesian coordinates (x, y). After transforming each point to polar coordinates (r, θ), the classes become easier to separate because one class is mainly characterized by a different radius. Which statements are consistent with this example?",
//     "answers": [
...
//   {
//     "question": "Which elements are part of evolutionary algorithm design?",
//     "answers": [
//       "Genetic operators",
//       "Fitness function",
...
//   },
//   {
//     "question": "For input 5 x 5, kernel 3 x 3, padding 0, and stride 1, which statements are correct?",
//     "answers": [
//       "The output size is 5 x 5 without padding.",
//       "The output size is 3 x 3.",
//       "H_out = floor((H_in - K_h + 2P)/S) + 1.",
//       "H_out = W_out = 3."
//     ],
//     "correct": "bcd"
//   },
...
//   },
//   {
//     "question": "Consider the following input matrix and filter used in a 2D cross-correlation operation with stride 1 and no padding:\nX = [[1, 2, 0, 1, 3], [0, 1, 2, 3, 1], [1, 0, 1, 2, 2], [2, 1, 0, 1, 0], [1, 3, 2, 0, 1]]\nF = [[1, 0, -1], [1, 0, -1], [1, 0, -1]]\nThe output is computed by cross-correlation, without flipping the filter. Which statements about the first row of the output feature map are correct?",
//     "answers": [
//       "Y_{1,3} = 0",
...
//     "answers": [
//       "Completeness can be written as ∀x ∈ X, ∃A such that μ_A(x) > 0.",
...
//   },
//   {
//     "question": "For a dataset D = {(x^(1), y^(1)), ..., (x^(m), y^(m))}, which statements about ERM are correct?",
//     "answers": [
//       "ERM can be written as ĥ ∈ arg min_{h} 1/m * Σ_{i=1}^{m} L(h(x^(i)), y^(i)).",
...
//       "Best chromosomes may dominate the selection",
...
//   },
//   {
//     "question": "Which statements correctly compare ReLU and Leaky ReLU?",
//     "answers": [
//       "It has the same form.",
//       "It has the same bias.",
//       "It has a hidden layer.",
//       "It has one hidden layer with only one unit."
//     ],
//     "correct": "a"
//   },
//   {
//     "question": "Which statements about activation-function problems are correct?",
//     "answers": [
//       "Sigmoid can suffer from vanishing gradients.",
//       "High costs can step into derivation calculation steps inside of the domains.",
//       "ReLU has no vanishing-gradient issues for x > 0.",
//       "Leaky ReLU tries to fix the dying ReLU problem."
//     ],
//     "correct": "acd"
//   },
//   {
//     "question": "For the update w^(k) = w^(k-1) - η * ∇f(w^(k-1)), which statements are correct?",
//     "answers": [
//       "∇f(w^(k-1)) is the gradient at the previous iteration.",
...
//     "answers": [
//       "Exact synthetic proof of optimality at every generation",
...
//   },
//   {
//     "question": "Which statements about fitness sharing are correct?",
//     "answers": [
//       "It uses a sharing function based on distance.",
//       "It is sensitive to the sharing radius σ_share.",
//       "It reduces the reward of individuals in crowded areas.",
//       "It completely eliminates the need for selection mechanisms."
//     ],
//     "correct": "abc"
//   },
//   {
...
//   },
//   {
//     "question": "Consider a 3 x 3 input matrix X and a 2 x 2 filter F used in a valid cross-correlation operation. Which expressions are correct for H_out and output dimensions?",
//     "answers": [
//       "H_out = W_out = 3.",
...
//       "Minimizing average loss emphasizes an optimization algorithm perspective.",
//       "ERM guarantees finding the absolute global minimum in all network types."
//     ],
//     "correct": "ac"
//   },
//   {
...
//       "The output can be computed as z* = (Σ α_i * z_i) / (Σ α_i)."
//     ],
//     "correct": "bcd"
//   },
//   {
...
//   },
//   {
//     "question": "Consider a 3 x 3 input matrix X and a 2 x 2 filter F used in a valid cross-correlation operation. Which expressions are correct for ∂E / ∂F_{1,1}?",
//     "answers": [
//       "It depends on the upstream gradient ∂E / ∂O.",
//       "It depends on the input values covered by F_{1,1}.",
//       "It is always equal to zero.",
//       "∂E/∂O_{1,1} * x_{1,1} + ∂E/∂O_{1,2} * x_{1,2} + ∂E/∂O_{2,1} * x_{2,1} + ∂E/∂O_{2,2} * x_{2,2}."
//     ],
//     "correct": "abd"
//   },
//   {
...
//     "answers": [
//       "A nonlinear transform ϕ(x) can be used in f(x) = W^T * ϕ(x).",
...
//       "A bottleneck block uses 1 x 1, 3 x 3, and 1 x 1 convolutions.",
...
//       "ERM is used because the expected risk is usually not directly computable.",
//       "ERM minimizes an average loss over the training dataset.",
//       "ERM can be written as ĥ ∈ arg min_{h ∈ H} 1/m * Σ_{i=1}^{m} L(h(x^(i)), y^(i))."
//     ],
//     "correct": "bcd"
//   },
//   {
...
//     "answers": [
//       "The neuron computes a weighted sum net = Σ_{i=1}^{n} w_i * x_i.",
...
//       "Gradient descent may use continuous outputs such as o^d = w * x^d or o^d = sig(w * x^d).",
...
//     "answers": [
//       "o_1^H = f(net_1^H).",
//       "net_1^H = (W_1^H)^T * X = w_{11}^H * x_1 + w_{12}^H * x_2.",
//       "net_2^H = (W_2^H)^T * X = w_{21}^H * x_1 + w_{22}^H * x_2.",
//       "o_2^H is computed without any activation function."
//     ],
//     "correct": "abc"
//   },
//   {
...
//   },
//   {
//     "question": "Which statements correctly distinguish Strong AI and Weak AI?",
//     "answers": [
//       "Weak AI necessarily implies that the system uses symbolic reasoning only.",
//       "Strong AI refers to hypothetical systems with a general intelligence comparable to human intelligence.",
...
//       "Training aims to obtain a learned hypothesis ĥ."
//     ],
//     "correct": "abd"
//   },
//   {
...
//     "question": "Which statements correctly distinguish minimizing average loss from Empirical Risk Minimization?",
//     "answers": [
//       "Minimizing average loss emphasizes an optimization algorithm perspective on a fixed dataset.",
//       "They are always completely different numerical problems.",
//       "ERM emphasizes a statistical learning viewpoint under an i.i.d. assumption.",
...
//   },
//   {
//     "question": "Which representations of uncertainty can be?",
//     "answers": [
//       "Probabilities",
//       "Fuzzy logic",
...
//   },
//   {
//     "question": "Which statements about ReLU are correct?",
//     "answers": [
...
const questions = [
  ...
  },
  {
    ...
    "answers": [
      ...
      "The perceptron's rule is based on gradient descent.",
      "They both start with some random weights.",
      "Perceptron's rule recomputes the weights based on individual instances while the delta rule evaluates all instances.",
      "The perceptron rule and delta rule always converge to the global optimum and are not affected by local minima.",
      "The perceptron rule and delta rule do not require any iterative optimization process and can achieve optimal weights in a single pass."
    ],
    "correct": "ac"
  ...
  },
  {
    "question": "The 'dying ReLU' problem refers to:",
    "answers": [
      "the values of the derivative becoming zero for inactive neurons",
      "the vanishing gradient problem across all positive inputs",
      "the absolute values of the activation function becoming infinitely positive",
      "none of the above"
    ],
    "correct": "a"
  },
  ...
  },
  {
    ...
    "answers": [
      "in practice, we have two tensors: the input and the kernel",
      "such implementation is impossible in practice",
      "the input and the kernel are zero everywhere except in the finite set of points",
      "by using a convolution operation"
    ],
    "correct": "d"
  },
  ...
  },
  {
    ...
    "answers": [
      "You never stop; this sort of algorithm runs forever adapting itself.",
      "When you found the parameters c1 and c2.",
      "When you reach a predefined number of iterations.",
      "After you evaluate the fitness function a predefined number of times."
    ],
    "correct": "cd"
  ...
  },
  {
    "question": "For a dataset D = {(x^(1), y^(1)), ..., (x^(m), y^(m))}, which statements about ERM are correct?",
    "answers": [
      "ERM can be written as ĥ ∈ arg min_{h} 1/m * Σ_{i=1}^{m} L(h(x^(i)), y^(i)).",
      "ERM requires knowing the true distribution p(x,y) exactly.",
      "ERM is used because the expected risk is usually not directly computable.",
      "ERM minimizes an average loss over the training dataset."
    ],
  ...
  },
  {
    ...
    "answers": [
      ...
      "Training can be formulated as solving an ERM problem.",
      "Training is the same thing as validation.",
      "Training aims to obtain a learned hypothesis ĥ."
    ],
    "correct": "abd"
  },
  {
